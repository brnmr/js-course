/**************************************************
  * dom-drag.js
  *
  * @param o     { HTML Element } - The element to act as the drag handle
  * @param oRoot { HTML Element } - The element to be dragged, if not specified, the handle will be the element dragged
  * @param minX, maxX, minY, maxY { Number } - The min and max coordinates allowed for the element
  * @param bSwapHorzRef - Toggle the horizontal coordinate system
  * @param bSwapVertRef - Toggle the vertical coordinate system
  * @param fxMapper, fyMapper { Function } - Functions for mapping x and y coordinates to others
  *
 ***************************************************/
...
var Drag = {
	...
	init : function(o, oRoot, minX, maxX, minY, maxY, bSwapHorzRef, bSwapVertRef, fXMapper, fYMapper)
	{
		...
		// Look to see if the user provided min/max and x/y coordinates
		o.minX	= typeof minX != 'undefined' ? minX : null;
		o.minY	= typeof minY != 'undefined' ? minY : null;
		o.maxX	= typeof maxX != 'undefined' ? maxX : null;
		o.maxY	= typeof maxY != 'undefined' ? maxY : null;

		// Check for any specified x and y coordiante mappers
	...
	start : function(e)
	{
		...
		// Get the current x and y coordiantes
		var y = parseInt(o.vmode ? o.root.style.top  : o.root.style.bottom);
		var x = parseInt(o.hmode ? o.root.style.left : o.root.style.right );

		// Call the user's function with the current x and y coordiantes
		...
		// If we're using CSS coordinate system
		if (o.hmode) {
		...
		// Watch for 'dragging' and 'drag end' event
